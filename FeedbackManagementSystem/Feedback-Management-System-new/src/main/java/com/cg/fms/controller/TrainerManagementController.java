...
public class TrainerManagementController {
	...
	public Trainer updateTrainer(@RequestBody Trainer trainer, @PathVariable("id") long trainerId) {
		return this.updateTrainer(trainer, trainerId);
	}
	
	@DeleteMapping("/deletetrainer/{id}")
	public ResponseEntity <Trainer> removeTrainer(@PathVariable("id") long trainerId) {
	...
	public Trainer viewTrainer(@PathVariable("id") long empId) {
